...
**/
  ...
  this.courses.push(new CourseNaiveStraight(ll0,ll1,lfl2cv,styles[0]));
  this.courses.push(new CourseNaiveCurved(ll0,ll1,lfl2cv,styles[1]));
  var ll2 = this.calcLl2();
  this.ll2 = ll2;
  this.courses.push(new CourseNaiveCurved(ll0,ll2,lfl2cv,styles[2]));
...
PlotNaive.prototype = {
  ...
  calcLl2 : function() {
    ...
    var lat2 = fInv(flat2);
    var dist2 = Math.sqrt(sqr(lon2-lon0)+sqr(f(lat2)-f(lat0)));
    //debug(`distN=${distN}, distM=${distM}, dist2=${dist2}`);
